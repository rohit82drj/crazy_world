...
<head>
	...
	@else
		<link rel="shortcut icon" href="{{asset('assets/media/logos/my-home-food.png')}}" />
	@endif
</head>
					...
					<div class="kt-login__container">
						<div class="kt-login__logo">
							@php $logo = App\Models\GeneralSetting::where('deleted_at',NULL)->value('logo'); @endphp
								...
								@else
									<img alt="Logo" src="{{asset('assets/media/logos/my-home-food.png')}}" style="height: 80px; width: 100px;" />
								@endif
						</div>
						@yield('content')
