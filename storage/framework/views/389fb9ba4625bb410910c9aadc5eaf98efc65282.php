...
<head>
	...
	<?php else: ?>
		<link rel="shortcut icon" href="<?php echo e(asset('assets/media/logos/my-home-food.png')); ?>" />
	<?php endif; ?>
</head>
					...
					<div class="kt-login__container">
						<div class="kt-login__logo">
							<?php $logo = App\Models\GeneralSetting::where('deleted_at',NULL)->value('logo'); ?>
								...
								<?php else: ?>
									<img alt="Logo" src="<?php echo e(asset('assets/media/logos/my-home-food.png')); ?>" style="height: 80px; width: 100px;" />
								<?php endif; ?>
						</div>
...
<?php /**PATH D:\rohit\CrazyWorld\crazy_world\resources\views/admin/layout/auth.blade.php ENDPATH**/ ?>