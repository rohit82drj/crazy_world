...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    ...
    'date'=>\Carbon\Carbon::parse($order_header->created_at)->format('d-m-Y')
						...
						?>
						<?php echo QrCode::size(250)->generate($d);; ?>
				...
				<table class="table table-hover">
					...
					<thead>
						<tr>
							...
							<th>SGSt</th>
							<th>Total Price</th>
							<?php if($order_header->order_status_id == 6): ?>
							<th>Reason</th>
							<th>Images</th>
							<th>Status</th>
							<th>Action</th>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel training\crazy_world\resources\views/adminseller/order/detail.blade.php ENDPATH**/ ?>