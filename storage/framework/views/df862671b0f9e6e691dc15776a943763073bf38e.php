...
<script type="text/javascript">
    ...
    function DiscountMultiple(ids) {
        ...
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('admin.product.get_discount_popup')); ?>",
            data: newurl,
            dataType: 'json',
    ...
    function savesellingprice($this,priceid,pid){
        $.ajax({
                type: "POST",
                url: "<?php echo e($product_priceselling_update); ?>",
...
<?php $__env->stopPush(); ?><?php /**PATH D:\Laravel training\crazy_world\resources\views/admin/layout/multiple_action.blade.php ENDPATH**/ ?>