                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="email" class="form-control" placeholder="Enter email ID" name="email" id="email" required autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel training\crazy_world\resources\views/adminseller/vendors/create.blade.php ENDPATH**/ ?>