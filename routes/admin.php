...
//affiliatey route
Route::get('/showProduct', 'Affiliatey\AffiliateyUserController@showProduct')->name('showProduct');
//save commission
Route::post('saveprocomm', 'Affiliatey\AffiliateyUserController@addcom')->name('saveprocomm');
// affiliatey user
Route::get('showuser', 'Affiliatey\AffiliateyUserController@showuser')->name('showuser');
Route::get('commission-history/{id}', 'Affiliatey\AffiliateyUserController@commissionhistory')->name('commissionhistory');
// userapproved 
Route::get('userapproved/{id}', 'Affiliatey\AffiliateyUserController@userapproved')->name('userapproved');
Route::get('showrefforder', 'Affiliatey\AffiliateyUserController@showrefforder')->name('showrefforder');

Route::get('showreforder/{id}', 'Affiliatey\AffiliateyUserController@showreforder')->name('showreforder');
Route::get('viewAffiliateyDetail/{id}', 'Affiliatey\AffiliateyUserController@viewAffiliateyDetail')->name('viewAffiliateyDetail');

Route::get('viewfunds/{id}', 'Affiliatey\AffiliateyUserController@viewfunds')->name('viewfunds');
Route::post('savefunds', 'Affiliatey\AffiliateyUserController@savefunds')->name('savefunds');
Route::post('updatefunds', 'Affiliatey\AffiliateyUserController@updatefunds')->name('updatefunds');
